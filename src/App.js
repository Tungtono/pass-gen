...
const App = () => {
    ...
    let customTemplate = `${
        passConfig.characterSet.upCase ? "ABCDEFGHIJKLMNOPQRSTUVWXYZ" : ""
    }${passConfig.characterSet.lowCase ? "abcdefghijklmnopqrstuvwxyz" : ""}${
        passConfig.characterSet.number ? "1234567890" : ""
    }${
        passConfig.characterSet.symbol ? `!"#$%&'()*+,-./:;<\`=>?@[]{}|^_` : ""
    }`;

    const generatePass = (tempStr, n) => {
        let result = "";
        for (let i = 0; i < n; i++) {
            result += tempStr.charAt(
    ...
    const handleCheckboxChange = (e) => {
        ...
        if (
            checkedboxLeft === 1 &&
            tempPassConfig.characterSet[e.target.value] === true
        ) {
            alert("You need to include at least 1 element");
        }
        tempPassConfig.characterSet[e.target.value] =
            !tempPassConfig.characterSet[e.target.value];
        tempPassConfig.security = validatePassword(tempPassConfig);
        setPassConfig(tempPassConfig);
    };
            ...
            <div className="content-container">
                ...
                <div className="pass-section">
                    <div className="password-box">
                        ...
                        <p
                            ...
                            style={{
                                backgroundColor: passConfig.security.badgeColor,
                            }}
                        >
                            {passConfig.security.level}
                        </p>
                        <button
                ...
                <div className="length-section">
                    <div className="length-text">
                        ...
                        <p name="length" id="length-output">
                            {passConfig.passLength}
                        </p>
                    </div>
                    ...
                    <div className="character-select">
                        <label className="character-box">
                            ...
                            <input
                                type="checkbox"
                                value="upCase"
                                defaultChecked={passConfig.characterSet.upCase}
                        ...
                        <label className="character-box">
                            ...
                            <input
                                type="checkbox"
                                value="lowCase"
                                defaultChecked={passConfig.characterSet.lowCase}
                                onChange={(e) => handleCheckboxChange(e)}
                            />
                            <span className="checkmark"></span>
                        </label>
                        <label className="character-box">
                            ...
                            <input
                                type="checkbox"
                                value="number"
                                defaultChecked={passConfig.characterSet.number}
                                onChange={(e) => handleCheckboxChange(e)}
                            />
                            <span className="checkmark"></span>
                        </label>
                        <label className="character-box">
                            ...
                            <input
                                type="checkbox"
                                value="symbol"
                                defaultChecked={passConfig.characterSet.symbol}
                                onChange={(e) => handleCheckboxChange(e)}
                            />
                            <span className="checkmark"></span>
                        </label>
